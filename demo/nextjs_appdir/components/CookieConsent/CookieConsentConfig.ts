    ...
    translations: {
      ...
      hr: {
        ...
        vendorsModal: {
          ...
          dataDeclarationLabel: 'Kategorije podataka',
          dataRetentionLabel: 'Zadržavanje podataka',
          standardRetentionLabel: 'Standardno zadržavanje',
          dataRetentionDaysLabel: 'Dana',
          consentPurposesLabel: 'Obrada podataka temeljem suglasnosti',
          legitimateInterestPurposesLabel: 'Obrada podataka temeljem opravdanih interesa',
